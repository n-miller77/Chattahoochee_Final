...
basic_sample_metadata <- read.csv("basic_sample_metadata_1124.csv")

########################################
########### Create Heatmap #############
########################################

input_data <- read.table("beta_diversity_no_wwtp_kreport.bracken.G.fixed.tsv",
...
custom_labels <- c(
  "file_sample1" = "AltLabel1",
  "file_sample2" = "AltLabel2",
  "file_sample3" = "AltLabel3"
...
# Colors
ann_colors = list(
  subsite = c(REG = "gray", UP = "coral1", DOWN = "coral4"),
  site = c(DAM="aliceblue", A="lightblue1", B="lightblue3",
           C="lightblue4", S1="mediumpurple1",
           S2="mediumpurple3", S3="mediumpurple4"),
  batch = c("period_1"="darkolivegreen1",
